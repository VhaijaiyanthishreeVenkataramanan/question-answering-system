...
class Attention(RNNCell):
    """Gated Recurrent Unit incoporating attention (cf. https://arxiv.org/abs/1603.01417).
       NOTE: input shape:  (batch_size, max_time_step, input_dim + 1)
       input vector: (batch_size, max_time_step, input_dim)
       scalar attention:  (batch_size, max_time_step, 1)
       input vector and scalar attention are concatenated along the final axis"""
    ...
    # Adapted from File: bn_gru.py Project: website-fingerprinting
    # Overriding
